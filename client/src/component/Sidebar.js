    ...
    <div>
      <ul>
        <Link to="/home">
          ...
          <b style={{ color: "black" }}>Anasayfa </b>
        </Link>
        <hr />
        <Link to="/">
          <i className="fa fa-bell" aria-hidden="true"></i>{" "}
          <b style={{ color: "black" }}>Keşfet</b>
        </Link>
        <hr />
        <Link to="/">
          <i className="fa fa-bookmark-o fa-1.5x" aria-hidden="true"></i>{" "}
          <b style={{ color: "black" }}>Yer İşaretleri</b>
        </Link>
        <hr />
        <Link to="/">
          <i className="fa fa-list-alt" aria-hidden="true"></i>{" "}
          <b style={{ color: "black" }}>Listeler</b>
        </Link>
        <hr />
        <Link to="/profile">
          <i className="fa fa-user" aria-hidden="true"></i>{" "}
          <b style={{ color: "black" }}>Profil</b>
        </Link>
        <hr />
      </ul>
      {isAuth ? (
