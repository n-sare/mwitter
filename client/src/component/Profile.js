    ...
    user.map((item) => (
      <div key={item._id}>
        ...
        <div className="desc">
          ...
          <p>
            <i className="fa fa-calendar" aria-hidden="true"></i> Haziran 2021 tarihinde katıldı
          </p>
        </div>
        <div className="follow">
          <p>
            <li onClick={handleFShow}>
              {" "}
              {item.followers && item.followers.length} Takipçi{" "}
            </li>
          </p>
          <p>
            <li onClick={handleFFShow}>
              {" "}
              {item.following && item.following.length} Takip edilen{" "}
            </li>
          </p>
        </div>
    ...
    <div className="main">
      ...
      <div className="main_section">
        ...
        <Modal show={show} onHide={handleClose}>
          ...
          <div className="file-field input-field">
            <div className="btn #64b5f6 blue darken-1">
              <label>Arkaplan resmi yükle</label>
              <input
                type="file"
